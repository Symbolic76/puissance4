...
## Explication de l'IA
Pour développer une IA fonctionnant avec ce sytème de matrice .txt, il faudrait que l'IA lise le fichier txt, et évalue selon un algorithme donné quel serait le meilleur coup à jouer en fonction des pions déjà posés afin d'obtenir un poucentage de chance maximal de remporter la partie.